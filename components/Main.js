...
function Main() {
    ...
    <div className='min-h-screen flex flex-col items-center bg-mainbg bg-cover bg-top'>
        ...
        >Welcome to my portfolio! I am a software developer from Ottawa, Ontario and I specialize in Reactjs. I am currently seeking a full-time position in full-stack or front-end development. </motion.p>}
        </div>
    </div>
    )
}
